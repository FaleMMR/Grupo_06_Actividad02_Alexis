...
public class InicioProyecto {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				km = sc.nextInt();
				coche = new Coche(0, marca, modelo, anio, km);
			...
			case 4:
				...
				System.out.println("Dime kilometros que tiene:");
				km = sc.nextInt();
				coche = new Coche(id, marca, modelo, anio, km);
			...
			case 6:
				...
				exito = controladorPasajero.crearPasajero(pasajero);
				if (exito == false) {
	...
	public static void pintamenu() {
		...
		System.out.println("    -------------------");
		System.out.println(" 6.- Crear pasajero");
